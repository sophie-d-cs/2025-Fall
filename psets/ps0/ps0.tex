...
% \usepackage{Fall25/classTools}
\usepackage{Fall25/IntroAlgorithmsAndLimitations}
\usepackage{graphicx}
\drafttrue
\hintstrue
\solutionstrue
...
\begin{document}
\psHeader{0}{Wed 2025-09-10 (11:59PM)}
...
% not using \solution here because it doesn't seem to work with the \begin{verbatim} block
...
% submit your solution to the seperate assignment on Gradescope
